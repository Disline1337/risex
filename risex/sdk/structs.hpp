...
public:
    ...
    VIRTUAL(GetWeaponData(), 461, weapon_info_t* (__thiscall*)(void*));
...
public:
    ...
    {
        Vector out;
        get_vfunc<void(__thiscall*)(void*, Vector&)>(this, 284)(this, out);
        return out;
    }
    ...
    template< typename t >
    inline void set(size_t offset, const t& val) { *reinterpret_cast<t*>(reinterpret_cast<std::size_t>(this) + offset) = val; }
    ...
    __forceinline void PostThink() {
        return call_virtual< void(__thiscall*)(decltype(this)) >(this, POSTTHINK)(this);
    }
    ...
    __forceinline void SetThinkTick(int tick) {
        int* pThinkTick = (int*)((DWORD)this + 0x40);
        *pThinkTick = tick;
    }
    ...
    float& m_flThirdpersonRecoil() {
        static auto _flThirdpersonRecoil = netvars::get().get_offset(crypt_str("CCSPlayer"), crypt_str("m_flThirdpersonRecoil"));
        return get< float >(_flThirdpersonRecoil);
    }
