...
struct ImGuiContext
{
    ...
    bool                    ScalarAsInputTextId;
    bool                    ActiveIdAllowNavDirFlags;
...
namespace ImGui
{
    ...
    IMGUI_API bool          Tab(const char* icon, const char* label, const bool active, const ImVec2& size_arg);
    IMGUI_API void          TextEx(const char* text, const char* text_end = NULL, ImGuiTextFlags flags = 0);
    IMGUI_API bool          SubTabEx(const char* label, const char* idz, const bool active, const ImVec2& size_arg);
    IMGUI_API bool          SubTab(const char* label, const char* id, const bool active, const ImVec2& size_arg);
    IMGUI_API bool          VisualsAdder(const char* label, const char* unique_id, const ImVec2& size_arg, bool clicked, ImGuiButtonFlags flags = 0);
    IMGUI_API bool;
